...
class adLDAP {
    ...
    */
    public function user_info($username,$fields=NULL,$isGUID=false){
        ...
        // LIGNE MODIFIEE CAR ERREUR EN CAS DE TABLEAU VIDE
        // ANCIENNE LIGNE : if ($entries[0]['count'] >= 1) {
        if ($entries['count'] >= 1) {
          ...
          // DEBUT LIGNE AJOUTEE CAR ERREUR EN CAS DE TABLEAU VIDE
        ...
        // LIGNE SUPPRIMEE CAR ERREUR EN CAS DE TABLEAU VIDE
        // ANCIENNE LIGNE : $entries[0]["memberof"]["count"]++;
        return ($entries);
    }
