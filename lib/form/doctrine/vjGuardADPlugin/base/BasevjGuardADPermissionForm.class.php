...
/**
 * vjGuardADPermission form base class.
 *
 * @method vjGuardADPermission getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasevjGuardADPermissionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vj_guard_ad_permission[%s]');
