...
/**
 * vjGuardADGroupPermission form base class.
 *
 * @method vjGuardADGroupPermission getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasevjGuardADGroupPermissionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vj_guard_ad_group_permission[%s]');
  ...
  {
    return 'vjGuardADGroupPermission';
  }
