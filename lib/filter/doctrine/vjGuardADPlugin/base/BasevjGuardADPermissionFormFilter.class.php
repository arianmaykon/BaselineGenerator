...
/**
 * vjGuardADPermission filter form base class.
 *
 ...
 */
abstract class BasevjGuardADPermissionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vj_guard_ad_permission_filters[%s]');
  ...
  public function addGroupsListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('vjGuardADGroupPermission.group_id', $values)
    ;
  }
  ...
  public function addUsersListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('vjGuardADUserPermission.user_id', $values)
    ;
  }

  public function getModelName()
  {
    return 'vjGuardADPermission';
  }
